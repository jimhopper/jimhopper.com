...
The first video lays out key principles that are applied in the second. (For desktop viewing, click twice quickly to start and pause, then click the speaker icon to hear my narration. Full-screen is an option too.)
